...
- Task alignment (2026-03-07, post-unlock delayed terminal catch-up investigation):
  ...
  - End Point: identify the most likely culprit cluster before code changes, with emphasis on whether the issue is a true timer bug versus delayed shell-output ingestion/render replay after occlusion/background throttling.
